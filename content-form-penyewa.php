  ...
  <div class="p-5" id="content">
    ...
    <h4 class="mb-3 text-center">Penyewaan</h4>
      ...
      <div class="mb-3 row ml-4">
        ...
        <div class="col-sm-8">
          <input type="date" class="form-control" id="inputKeperluan" name="tanggal">
        </div>
      </div>
      <div class="mb-3 row ml-4">
        <label for="inputJam-mulai" class="col-sm-2 col-form-label text-right">Jam Mulai</label>
        <div class="col-sm-3">
          <input type="time" class="form-control" id="inputJam-mulai" name="jam_mulai">
        </div>
        <label for="inputJam-akhir" class="col-sm-2 col-form-label text-right">Sampai</label>
        <div class="col-sm-3">
          <input type="time" class="form-control" id="inputJam-akhir" name="jam_akhir">
        </div>
      </div>
      <div class="mb-3 row ml-4">
        <label for="inputKeperluan" class="col-sm-2 col-form-label text-right">Keperluan</label>
        <div class="col-sm-8">
          <select id="inputKeperluan" class="form-control" name="keperluan">
                <option selected>Seminar/Kuliah</option>
                <option class="font-weight-normal">Seminar</option>
                <option class="font-weight-normal">Kuliah</option>
                <option class="font-weight-normal">Lainnya</option>
              </select>
        </div>
      </div>
      <div class="mb-3 row ml-4">
        ...
        <div class="col-sm-8">
          <select id="inputPembayaran" class="form-control" name="pembayaran">
                <option selected>Tunai/Gopay</option>
                <option class="font-weight-normal">Tunai</option>
                <option class="font-weight-normal">Gopay</option>
              </select>
        </div>
      </div>
      <div class="mb-3 row">
